...
function acf_fc_modal_init() {
  jQuery(".acf-flexible-content .layout:not(.acf-clone)").each(function() {
    ...
    if (layout.parents(".acf-fields").length > 1) return true;
    else layout.addClass("fc-modal");
    ...
    if (controls.is("ul"))
      controls.append(
        '<li><a class="acf-icon -pencil small light" href="#" data-event="edit-layout" title="Edit layout"></a></li>'
      );
    else
      controls.append(
        '<a class="acf-icon -pencil small light" href="#" data-event="edit-layout" title="Edit layout"></a>'
      );
    layout
...
function acf_fc_modal_open() {
  ...
  if (!layout.hasClass("-modal")) {
    ...
    layout
      ...
      .html(
        '<a class="acf-icon -cancel" href="javascript:acf_fc_modal_remove()">'
      );
    layout.addClass("-modal");
    jQuery("body").append(
      "<div id='acf-flexible-content-modal-overlay'></div>"
    );
